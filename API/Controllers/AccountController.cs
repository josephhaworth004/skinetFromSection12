...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        // When we hit this account, this method will execute straight away
        [Authorize]
        [HttpGet]
        public async Task<ActionResult<UserDto>> GetCurrentUser()
        {
            // Find currently loggied in user by search for their email
            // This will be stored in the HTTP context
